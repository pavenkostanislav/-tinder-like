...
function addStringDependencyToSharedConfig(sharedConfig, dependency, projectGraph) {
    ...
    if (projectGraph.nodes[dependency]) {
        ...
        const config = (0, mfe_webpack_1.getNpmPackageSharedConfig)(dependency, (_c = (_b = pkgJson.dependencies) === null || _b === void 0 ? void 0 : _b[dependency]) !== null && _c !== void 0 ? _c : (_d = pkgJson.devDependencies) === null || _d === void 0 ? void 0 : _d[dependency]);
        if (!config) {
            return;
        }
